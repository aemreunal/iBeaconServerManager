    ...
    private class QueryActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (response.getCode() == 200) {
                // Normal response
                String[][] querResponse = APITab.convertQueryJsonToTable(response.getBody().getObject());
                responsePanel.showResponseTable(ItemTable.API_QUERY_TABLE_COL_NAMES, querResponse);
            }
        }
    }
}
