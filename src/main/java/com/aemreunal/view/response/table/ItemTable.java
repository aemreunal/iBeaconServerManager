...
public class ItemTable extends JTable {
    ...
    public static final String[] REGIONS_TABLE_COL_NAMES   = { "Region ID", "Name", "Description", "Display Name", "Last Updated", "Creation Date" };
    public static final String[] BEACONS_TABLE_COL_NAMES   = { "Beacon ID", "UUID", "Major", "Minor", "X Coor.", "Y Coor.", "Designated?", "Has info?", "Scenario ID", "Description", "Display Name", "Creation Date" };
